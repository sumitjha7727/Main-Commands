...
namespace Main_Commands
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Dispose()  -------> Close All Browser Object End Sessions Safely .
            //IWebDriver.Dispose()

            //Quit()   ---------> Internaly Calles Dispose()
            //IWebDriver.Quit()

            //FindElement() ---> Find one WebElement From WebPage using proprties  Xpath,Class,CssSelector,ID,name.

            //IWebElement ISearchContext.FindElement(By.Xpath(xpathexpression))
            //Return type of FindElement method is IWebElement.

            //FindElements() ---> Find Many WebElement From WebPage using proprties  Xpath,Class,CssSelector,ID,names.

            //IWebElement ISearchContext.FindElement(By.Xpath(xpathexpression))
            //Return type of FindElement method is IWebElement.

            //SwitchTo()----> Switch to Frames,Windows.Alert,ActiveElement.
